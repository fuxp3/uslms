...
public final class Constants {
    ...
    public static final String TYPE1_STR = "马克思列宁主义、毛泽东思想、邓小平理论";
    public static final String TYPE2_STR = "哲学、宗教";
    public static final String TYPE3_STR = "文化、科学、教育、体育";
    public static final String TYPE4_STR = "政治、法律";
    public static final String TYPE5_STR = "历史、地理";
